...
namespace UniTransnap
{
    ...
    public class AzureAuthToken
    {
        ...
        public async Task<string> GetAccessTokenAsync()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("AccessToken time is too short!!!");
            ...
            using (var request = new HttpRequestMessage())
            {
                ...
                System.Diagnostics.Debug.WriteLine("AccessToken is " + storedTokenValue);
                return storedTokenValue;
            }
        }
        ...
        public string GetAccessToken()
        {
            ...
            System.Diagnostics.Debug.WriteLine("c" + accessToken);
            if(accessToken == null)
                System.Diagnostics.Debug.WriteLine("AccessToken is nul!!!" + accessToken);
