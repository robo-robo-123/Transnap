...
// 
namespace UniTransnap.Translator {
    ...
    public partial class GetTranslationsResponse : object, System.ComponentModel.INotifyPropertyChanged {
        ...
        private System.Collections.ObjectModel.ObservableCollection<UniTransnap.Translator.TranslationMatch> TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public System.Collections.ObjectModel.ObservableCollection<UniTransnap.Translator.TranslationMatch> Translations {
            get {
    ...
    public interface LanguageService {
        ...
        System.Threading.Tasks.Task<UniTransnap.Translator.GetTranslationsResponse> GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, UniTransnap.Translator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        System.Threading.Tasks.Task AddTranslationArrayAsync(string appId, System.Collections.ObjectModel.ObservableCollection<UniTransnap.Translator.Translation> translations, string from, string to, UniTransnap.Translator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<UniTransnap.Translator.GetTranslationsResponse>> GetTranslationsArrayAsync(string appId, System.Collections.ObjectModel.ObservableCollection<string> texts, string from, string to, int maxTranslations, UniTransnap.Translator.TranslateOptions options);
        ...
        System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<UniTransnap.Translator.TranslateArrayResponse>> TranslateArrayAsync(string appId, System.Collections.ObjectModel.ObservableCollection<string> texts, string from, string to, UniTransnap.Translator.TranslateOptions options);
        ...
        System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<UniTransnap.Translator.TranslateArray2Response>> TranslateArray2Async(string appId, System.Collections.ObjectModel.ObservableCollection<string> texts, string from, string to, UniTransnap.Translator.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : UniTransnap.Translator.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<UniTransnap.Translator.LanguageService>, UniTransnap.Translator.LanguageService {
        ...
        public System.Threading.Tasks.Task<UniTransnap.Translator.GetTranslationsResponse> GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, UniTransnap.Translator.TranslateOptions options) {
        ...
        public System.Threading.Tasks.Task AddTranslationArrayAsync(string appId, System.Collections.ObjectModel.ObservableCollection<UniTransnap.Translator.Translation> translations, string from, string to, UniTransnap.Translator.TranslateOptions options) {
        ...
        public System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<UniTransnap.Translator.TranslateArrayResponse>> TranslateArrayAsync(string appId, System.Collections.ObjectModel.ObservableCollection<string> texts, string from, string to, UniTransnap.Translator.TranslateOptions options) {
            return base.Channel.TranslateArrayAsync(appId, texts, from, to, options);
        }
        
        public System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<UniTransnap.Translator.TranslateArray2Response>> TranslateArray2Async(string appId, System.Collections.ObjectModel.ObservableCollection<string> texts, string from, string to, UniTransnap.Translator.TranslateOptions options) {
